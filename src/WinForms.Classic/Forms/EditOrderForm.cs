    ...
    public partial class EditOrderForm : DevExpress.XtraBars.Ribbon.RibbonForm {
        ...
        private void btnSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e) {
            try {
                ...
                XtraMessageBox.Show(this, "The record was modified or deleted. Please click the Reload button and try again.", "Inventory XPO", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
        }
