...
namespace WinForms.MVVM.ViewModels {
    public class EditOrderViewModel : ISupportParameter, IDocumentContent {
        ...
        public async void Save() {
            try {
                ...
                MessageBoxService.ShowMessage("The object was modified by another user. Please reload data.", "Inventory XPO", MessageButton.OK, MessageIcon.Stop);
                return;
            }
